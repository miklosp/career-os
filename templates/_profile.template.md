...
<!-- Map YOUR projects to each archetype. Example:
     | Platform / LLMOps | My monitoring dashboard project | config/cv.md |
     | Agentic | My chatbot with HITL escalation | config/cv.md section 3 | -->

| If the role is... | Emphasize about you... | Proof point sources |
|-------------------|------------------------|---------------------|
| Platform / LLMOps | Production systems builder, observability, evals | config/cv.md |
| Agentic / Automation | Multi-agent orchestration, HITL, reliability | config/cv.md |
| Technical AI PM | Product discovery, PRDs, metrics | config/cv.md |
| Solutions Architect | System design, integrations, enterprise-ready | config/cv.md |
| Forward Deployed Engineer | Fast delivery, client-facing, prototype to prod | config/cv.md |
| AI Transformation Lead | Change management, team enablement, adoption | config/cv.md |
...
- **In STAR stories:** Reference proof points from `config/cv.md`
