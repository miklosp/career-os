...
// Uses GENERATION_MODEL via the LLM provider. One call. Output: data/reports/_gap-analysis.md
//
...
const OUTPUT = 'data/reports/_gap-analysis.md';
const LLM_PROVIDER_URL = process.env.LLM_PROVIDER_URL;
const MODEL = process.env.GENERATION_MODEL;
if (!LLM_PROVIDER_URL || !MODEL) {
  console.error('❌ LLM_PROVIDER_URL and GENERATION_MODEL must both be set in the environment.');
  process.exit(1);
}
