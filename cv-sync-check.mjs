 ...
 * 3. No hardcoded metrics in _shared.md or modes/_eval.md
...
if (!existsSync(profilePath)) {
  errors.push('config/profile.yml not found. Copy from templates/profile.example.yml and fill in your details.');
} else {
...
const filesToCheck = [
  ...
  { path: join(projectRoot, 'modes', '_eval.md'), name: '_eval.md' },
];
